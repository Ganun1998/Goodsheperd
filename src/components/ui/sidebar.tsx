...
// SidebarTrigger without variants
const SidebarTrigger = React.forwardRef<React.ElementRef<typeof Button>, React.ComponentProps<typeof Button>>(
  ({ className, onClick, ...props }, ref) => {
    const { toggleSidebar } = useSidebar();
    return (
      <Button ref={ref} data-sidebar="trigger" className={cn("h-7 w-7", className)} onClick={(e) => { onClick?.(e); toggleSidebar(); }} {...props}>
        <PanelLeft />
...
// Remaining components (SidebarInput, SidebarHeader, SidebarFooter, SidebarSeparator, SidebarContent, SidebarMenu, etc.) remain the same, just remove variant-related props.
